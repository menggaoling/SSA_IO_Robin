...
//miketsai -- typedef __IO int32_t  vs32;
...
//miketsai -- typedef uint32_t  u32;
//typedef uint16_t u16;
//typedef uint8_t  u8;

//miketsai -- typedef const uint32_t uc32;  /*!< Read Only */
//typedef const uint16_t uc16;  /*!< Read Only */
//typedef const uint8_t uc8;   /*!< Read Only */

//miketsai -- typedef __IO uint32_t  vu32;
//typedef __IO uint16_t vu16;
//typedef __IO uint8_t  vu8;

//miketsai -- typedef __I uint32_t vuc32;  /*!< Read Only */
//typedef __I uint16_t vuc16;  /*!< Read Only */
//typedef __I uint8_t vuc8;   /*!< Read Only */

#ifndef __cplusplus
//miketsai -- typedef enum {FALSE = 0, TRUE = !FALSE} bool;
#endif

//miketsai -- typedef enum {RESET = 0, SET = !RESET} FlagStatus, ITStatus;

//miketsai -- typedef enum {DISABLE = 0, ENABLE = !DISABLE} FunctionalState;
//#define IS_FUNCTIONAL_STATE(STATE) (((STATE) == DISABLE) || ((STATE) == ENABLE))

//miketsai -- typedef enum {ERROR = 0, SUCCESS = !ERROR} ErrorStatus;
