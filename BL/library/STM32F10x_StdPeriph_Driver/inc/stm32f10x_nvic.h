...
#define USART4_IRQChannel            ((u8)0x34)  /* USART4 global Interrupt */
#define USART5_IRQChannel            ((u8)0x35)  /* USART5 global Interrupt */
...
#define IS_NVIC_IRQ_CHANNEL(CHANNEL) ((CHANNEL == WWDG_IRQChannel) || \
                                      ...
                                      (CHANNEL == USART4_IRQChannel) || \
                                      (CHANNEL == USART5_IRQChannel)    )
